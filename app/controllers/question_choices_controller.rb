class QuestionChoicesController < ApplicationController
  ...
  def new
    ...
    @question_choice.question_item_id = params[:id]
  ...
  def create
    ...
    respond_to do |format|
      if @question_choice.save
        format.html { redirect_to '/question_choices/new/' + @question_choice.question_item_id.to_s }
  ...
  private
    ...
    def question_choice_params
      params.require(:question_choice).permit(:question_item_id, :content, :value, :correct)
    end
end
