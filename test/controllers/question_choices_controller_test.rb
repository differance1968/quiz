...
class QuestionChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_choice" do
    assert_difference('QuestionChoice.count') do
      post question_choices_url, params: { question_choice: { content: @question_choice.content, correct: @question_choice.correct, question_item_id: @question_choice.question_item_id, value: @question_choice.value } }
    end
  ...
  test "should update question_choice" do
    patch question_choice_url(@question_choice), params: { question_choice: { content: @question_choice.content, correct: @question_choice.correct, question_item_id: @question_choice.question_item_id, value: @question_choice.value } }
